...
class CalculateTotalIncome {
	 ...
	 */
    void CalculateTotalIncomeAmount(ArrayList<Apartment> apartments, ArrayList<House> houses, ArrayList<Villa> villas)
	{
		int i;
		...
		for(i = 0; i < 3; i++)
		{
            totalIncome = totalIncome + apartments.get(i).getTotalRentalDays() * apartments.get(i).getCostPerDay();
		}
